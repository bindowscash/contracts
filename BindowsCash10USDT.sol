/**
Bindows.cash USDT mixer - 10 USDT pool
...
contract BindowsCash10USDT {
    ...
    uint256 public constant MIX_AMOUNT = 10_000_000_000_000_000_000; // 10 * 10^18 (18 decimals = 18 USDT)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 10 USDT from sender to contract
        bool sent = usdt.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDT transfer failed (Make sure you deposit exactly 10 USDT)");
