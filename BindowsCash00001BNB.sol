/**
Bindows.cash BNB mixer - 0.0001 BNB pool
...
BindowsCash is a non-custodial mixer operating on BSC, that breaks on-chain links between sender and recipient.
...
contract BindowsCash00001BNB {
    ...
    uint256 public constant MIX_AMOUNT = 0.0001 ether;
