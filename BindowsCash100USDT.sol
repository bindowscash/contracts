/**
Bindows.cash USDT mixer - 100 USDT pool
...
contract BindowsCash100USDT {
    ...
    uint256 public constant MIX_AMOUNT = 100_000_000_000_000_000_000; // 100 * 10^18 (18 decimals = 100 USDT)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 100 USDT from sender to contract
        bool sent = usdt.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDT transfer failed (Make sure you deposit exactly 100 USDT)");
