/**
Bindows.cash BNB mixer - 0.1 USDT pool
...
contract BindowsCash01USDT {
    ...
    uint256 public constant MIX_AMOUNT = 1_000_000_000_000_000_00; // 1 * 10^17 (17 decimals = 0.1 USDT)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        // Transfer 0.1 USDT from sender to contract
        bool sent = usdt.transferFrom(msg.sender, address(this), MIX_AMOUNT);
        require(sent, "USDT transfer failed (Make sure you deposit exactly 0.1 USDT)");
