/**
Bindows.cash USDT mixer - 1 USDT pool
...
contract BindowsCash1USDT {
    ...
    uint256 public constant MIX_AMOUNT = 1_000_000_000_000_000_000; // 1 * 10^17 (18 decimals = 1 USDT)
    ...
    function deposit(bytes32 commitment) external payable {
        ...
        require(sent, "USDT transfer failed (Make sure you deposit exactly 1 USDT)");
